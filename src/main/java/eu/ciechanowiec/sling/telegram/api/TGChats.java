...
public interface TGChats {
     ...
     * @param withTGBotID  entity with an ID that uniquely identifies a {@link TGBot} that is supposed to be associated
     *                     with the retrieved {@link TGChat}
     * @return an instance of an existing {@link TGChat}; if it doesn't exist yet, a new instance is created and
     * returned
     */
