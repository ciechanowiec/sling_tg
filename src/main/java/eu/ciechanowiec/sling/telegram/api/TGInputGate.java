...
public interface TGInputGate extends LongPollingUpdateConsumer {
     ...
     * @return {@link List} of {@link CompletableFuture} instances where every instance represents
     *         a {@link CompletableFuture} used to asynchronously consume a single {@link Update} instance
     */
    List<CompletableFuture<Void>> consumeAsync(List<Update> updates);

    /**
     * Passes the specified {@link Update} instance to asynchronous consumption by
     * {@link TGInputGate#consume(Update)}.
