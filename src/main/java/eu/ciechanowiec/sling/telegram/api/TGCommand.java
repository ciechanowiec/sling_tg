...
public interface TGCommand {
    ...
    /**
     * Answers whether this {@link TGCommand} is listable. A {@link TGCommand} is listable when it is supposed to be
     * visible to a non-bot {@link TGActor} in a {@link TGChat} and can be sent by that {@link TGActor}.
     *
    ...
    /**
     * Answers whether the {@link TGCommand#literal()} method of this {@link TGCommand} produces
     * {@link TGCommand#START_LITERAL}.
     *
