...
public interface TGMessage extends StagedNode<TGMessage> {
    ...
    /**
     * {@link Optional} with a {@link TGDocument} attached to this {@link TGMessage}. If there is no such
     * {@link TGDocument}, an empty {@link Optional} is returned.
     *
     * @return {@link Optional} with a {@link TGDocument} attached to this {@link TGMessage}; if there is no such
     * {@link TGDocument}, an empty {@link Optional} is returned
     */
     ...
     *
     * @return {@link Optional} with a {@link TGVideo} attached to this {@link TGMessage}; if there is no such
     * {@link TGVideo}, an empty {@link Optional} is returned
     */
     ...
     * an empty {@link Optional} is returned.
     *
     * @return {@link Optional} with a {@link TGAudio} attached to this {@link TGMessage}; if there is no such
     * {@link TGAudio}, an empty {@link Optional} is returned
     */
     ...
     * an empty {@link Optional} is returned.
     *
     * @return {@link Optional} with a {@link TGVoice} attached to this {@link TGMessage}; if there is no such
     * {@link TGVoice}, an empty {@link Optional} is returned
     */
     ...
     * <p>
     * A listable {@link TGCommand} is a {@link TGCommand} that returns {@code true} when {@link TGCommand#isListable()}
     * is called.
     *
