...
public interface TGCommands {
    ...
    /**
     * Creates a {@link SetMyCommands} composed of all instances from this {@link TGCommands} instance that
     * return {@code true} when called {@link TGCommand#isListable()}.
     * @param locale {@link Locale} that will be used to set the language code of the {@link SetMyCommands}
     * @return {@link Optional} containing {@link SetMyCommands} composed of all instances from this
     *         {@link TGCommands} instance that return {@code true} when called {@link TGCommand#isListable()};
     *         empty {@link Optional} is returned if there are no such instances in this {@link TGCommands}
     */
